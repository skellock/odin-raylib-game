...
point_in_rotated_rect_90_degrees :: proc(t: ^testing.T) {
	...
	testing.expect(t, !point_in_rotated_rect({50, 30}, rect, 90), "original center should be outside after 90° rotation")
...
point_in_rotated_rect_180_degrees :: proc(t: ^testing.T) {
	...
	rect := rl.Rectangle{10, 10, 100, 50}
	testing.expect(t, !point_in_rotated_rect({50, 30}, rect, 180), "original center should be outside after 180° rotation")

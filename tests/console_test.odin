...
console_update_backspace_test :: proc(t: ^testing.T) {
	...
	console_update(&game)
	testing.expect_value(t, console_get_value(&game.console), "hell")

	// "hell" -> "hel"
	game.actions.console.backspace = true
	console_update(&game)
	testing.expect_value(t, console_get_value(&game.console), "hel")

	// keep going until empty
	game.actions.console.backspace = true
	console_update(&game)
	testing.expect_value(t, console_get_value(&game.console), "he")

	game.actions.console.backspace = true
	console_update(&game)
	testing.expect_value(t, console_get_value(&game.console), "h")

	game.actions.console.backspace = true
	console_update(&game)
	testing.expect_value(t, console_get_value(&game.console), "")
...
console_update_backspace_word_test :: proc(t: ^testing.T) {
	...
	console_update(&game)
	testing.expect_value(t, console_get_value(&game.console), "hello")
	...
	game.actions.console.backspace_word = true
	console_update(&game)
	testing.expect_value(t, console_get_value(&game.console), "one two")
	...
	game.actions.console.backspace_word = true
	console_update(&game)
	testing.expect_value(t, console_get_value(&game.console), "trailing")

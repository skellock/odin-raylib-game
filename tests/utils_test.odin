...
point_in_rotated_rect_no_rotation :: proc(t: ^testing.T) {
	...
	testing.expect(t, main.point_in_rotated_rect({50, 30}, rect, 0), "center should be inside")
	testing.expect(
		t,
		!main.point_in_rotated_rect({5, 30}, rect, 0),
		"left of rect should be outside",
	)
	testing.expect(
		t,
		!main.point_in_rotated_rect({50, 5}, rect, 0),
		"above rect should be outside",
	)
	testing.expect(
		t,
		main.point_in_rotated_rect({10, 10}, rect, 0),
		"top-left corner should be inside",
	)
	testing.expect(
		t,
		main.point_in_rotated_rect({110, 60}, rect, 0),
...
point_in_rotated_rect_90_degrees :: proc(t: ^testing.T) {
	...
	testing.expect(
		t,
		!main.point_in_rotated_rect({50, 30}, rect, 90),
	...
	testing.expect(
		t,
		main.point_in_rotated_rect({-20, 60}, rect, 90),
		"should be inside rotated rect",
	)
}
